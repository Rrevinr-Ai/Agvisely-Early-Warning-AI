...
class GPTBackupService:
    ...
    async def weather_backup(
        ...
        prompt = (
            ...
            "- agent_speech: 5-7 sentences of natural spoken Bangla. Start with area and estimated "
            "temperature. Say which crops should be planted now, which crops may be ready to harvest, "
            "and what farm work is urgent this week. Sound like a caring extension officer.\n"
            ...
            "- crops_to_plant: Bangla — crops to plant now and why\n"
            "- crops_to_harvest: Bangla — crops likely ready to harvest and how to handle harvest\n"
            "- urgent_actions: Bangla — 2-3 urgent things farmer should do this week\n"
